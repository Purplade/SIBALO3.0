...
<head>
    ...
    <title>SIBALO - Halaman Login Admin</title>
    <!-- CSS files -->
        ...
        <div class="container container-normal py-4">
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg d-none d-lg-block">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 320px;">
                        <a href="/login" class="navbar-brand navbar-brand-autodark mb-2" aria-label="Ke Halaman Pegawai">
                            <img src="{{ asset('assets/img/logosekolah.png') }}" height="80" alt="Logo Sekolah">
                        </a>
                        <div class="h1 mb-1">SIBALO</div>
                        <div class="text-muted">Sistem Informasi Absensi Berbasis Lokasi</div>
                    </div>
                </div>
            </div>
        </div>
